...
//                System.out.println("Esc Clicked....!");
        ...
        spRootPaneB2CLarge1.addEventFilter(KeyEvent.KEY_PRESSED, (KeyEvent event) -> {
            if (event.getCode() == KeyCode.DOWN && tfGstr1B2CLarge1FromDt.isFocused()){
                tblvB2CLarge1List.getSelectionModel().select(0);
        ...
        tblvB2CLarge1List.addEventFilter(KeyEvent.ANY, (KeyEvent event) -> {
            if (event.getCode() == KeyCode.ENTER) {
                GSTR1B2CLarge1DTO selectedItem = (GSTR1B2CLarge1DTO) tblvB2CLarge1List.getSelectionModel().getSelectedItem();
                String state_id = selectedItem.getState_id();
                String rate_of_tax = selectedItem.getRate_of_tax();
        ...
        setKeyPressedHandler(tfGstr1B2CLarge1FromDt);
        setKeyPressedHandler(tfGstr1B2CLarge1ToDt);
        setKeyPressedHandler(tfGstr1B2CLarge1Search);
        setKeyPressedHandler(GSTR1B2CL1BtnPdf);
        setKeyPressedHandler(GSTR11B2CL1BtnExcel);
        setKeyPressedHandler(GSTR11B2CL1BtnCsv);
        setKeyPressedHandler(GSTR11B2CL1BtnPrint);
        tblvB2CLarge1List.requestFocus();
