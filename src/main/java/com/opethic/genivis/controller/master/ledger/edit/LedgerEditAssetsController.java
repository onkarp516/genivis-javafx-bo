...
public class LedgerEditAssetsController implements Initializable {

    @FXML
    private Button btnLedgerEditAssetsSubmit;

    @FXML
    private BorderPane stpaneother;

    @FXML
    private Button btnLedgerEditAssetsCancel;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        btnLedgerEditAssetsSubmit.setOnAction(actionEvent -> {

            globalLedgerEditController.fcCallLedgerEditOtherSubmit();

        });
        btnLedgerEditAssetsCancel.setOnAction(actionEvent -> {
            globalLedgerEditController.fcCallLedgerEditOtherCancel();
        });

        btnLedgerEditAssetsSubmit.setOnKeyPressed(event -> {
            if (event.getCode() == KeyCode.RIGHT) {
                btnLedgerEditAssetsCancel.requestFocus();
            }
        });
