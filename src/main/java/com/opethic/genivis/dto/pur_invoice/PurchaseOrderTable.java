...
public class PurchaseOrderTable {
    ...
    private SimpleStringProperty productCode = new SimpleStringProperty("0");
    private SimpleStringProperty current_index;

    private SimpleStringProperty sr_no;
    private SimpleStringProperty particulars;

    private SimpleStringProperty packages;
    private SimpleStringProperty levelA;
    private SimpleStringProperty levelB;
    private SimpleStringProperty levelC;
    ...
    private SimpleStringProperty net_amount;
    ...
    private List<UnitRateList> rateList = new ArrayList<>();
    ...
    public PurchaseOrderTable(String id, String current_index, String sr_no, String particulars, String packages, String levelA, String levelB, String levelC, String unit, String batch_or_serial, String quantity, String rate, String gross_amount, String dis_per, String dis_amt, String tax, String net_amount, String action) {
        ...
        this.net_amount = new SimpleStringProperty(net_amount.isEmpty()?"":Globals.twoDecimalFormat.format(Double.parseDouble(net_amount)));
    ...
    public String getNet_amount() {
        return net_amount.get().isEmpty() ?"":Globals.twoDecimalFormat.format(Double.parseDouble(net_amount.get()));
    }
    ...
    public void setNet_amount(String net_amount) {
        this.net_amount.set(net_amount.isEmpty()?"":Globals.twoDecimalFormat.format(Double.parseDouble(net_amount)));
    }
    ...
    public String toString() {
        ...
        jsonObject.addProperty("productCode", productCode.getValue());
        ...
        jsonObject.addProperty("productUnit", unitName.getValue());
        jsonObject.addProperty("qty", quantity.getValue());
