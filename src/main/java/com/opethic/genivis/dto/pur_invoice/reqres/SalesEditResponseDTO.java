...
public class SalesEditResponseDTO {
    ...
    @Expose
    private SalesInvoiceDataResDTO invoiceData;
    ...
    public SalesInvoiceDataResDTO getInvoiceData() {
        return invoiceData;
    }

    public void setInvoiceData(SalesInvoiceDataResDTO invoiceData) {
