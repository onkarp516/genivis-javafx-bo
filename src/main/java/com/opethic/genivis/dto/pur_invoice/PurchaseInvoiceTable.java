...
public class PurchaseInvoiceTable {
    ...
    private SimpleStringProperty product_id = new SimpleStringProperty("");
    ...
    public PurchaseInvoiceTable(String id, String current_index, String sr_no, String particulars, String packages, String levelA, String levelB, String levelC, String unit, String batch_or_serial, String quantity, String rate, String gross_amount, String dis_per, String dis_amt, String tax, String net_amount, String action) {
    ...
    public String toString() {
        ...
        if (!quantity.getValue().isEmpty())
            floatValue = Float.parseFloat(quantity.getValue());
