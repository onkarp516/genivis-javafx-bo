...
public class SalesEditResponseDTO1 {
    ...
    @SerializedName("row")
    @Expose
    private List<SalesRowListDTO> row;
    @SerializedName("invoice_data")
    @Expose
    private SalesInvoiceDataResDTO1 invoiceData;
    ...
    public List<SalesRowListDTO> getRow() {
        return row;
    }

    public void setRow(List<SalesRowListDTO> row) {
        this.row = row;
    }

    public SalesInvoiceDataResDTO1 getInvoiceData() {
        return invoiceData;
    }

    public void setInvoiceData(SalesInvoiceDataResDTO1 invoiceData) {
