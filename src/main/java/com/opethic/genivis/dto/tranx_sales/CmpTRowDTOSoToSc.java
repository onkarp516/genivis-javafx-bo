package com.opethic.genivis.dto.tranx_sales;
...
public class CmpTRowDTOSoToSc {  //replica of CmptRowDTO OR PurchaseInvoiceTable for the cmptrow
...
//    private SimpleStringProperty add_chg_amt = new SimpleStringProperty("0.0");
    ...
    public CmpTRowDTOSoToSc(String id, String current_index, String sr_no, String particulars,String packages, String levelA, String levelB, String levelC, String unit, String batch_or_serial, String quantity,String free, String rate, String gross_amount, String dis_per, String dis_amt, String tax, String net_amount, String action) {
