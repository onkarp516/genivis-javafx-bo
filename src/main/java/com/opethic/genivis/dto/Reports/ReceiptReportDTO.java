...
public class ReceiptReportDTO {
    ...
    private SimpleStringProperty voucher_no;           //receipt number
    ...
    public ReceiptReportDTO(String startDate, String endDate,String companyName, String rowId,String tranxDate,String voucherNo,String voucherId, String particular,
