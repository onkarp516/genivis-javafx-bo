...
public class PaymentReportScreen2DTO {
    ...
    public PaymentReportScreen2DTO(String month, String noOfVouchers, String endDate, String totalAmt, String startDate) {
        this.month = new SimpleStringProperty(month);
        this.no_vouchers = new SimpleStringProperty(noOfVouchers);
