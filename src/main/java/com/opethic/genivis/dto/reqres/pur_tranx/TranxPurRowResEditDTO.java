...
public class TranxPurRowResEditDTO implements Serializable {
      ...
      /*  @SerializedName("returnable_qty")
        ...
        public TranxPurRowResEditDTO() {
        }

//        public TranxPurRowResEditDTO(Long detailsId, Long productId, String productName, String levelAId,reference_id,reference_type
//                                     String levelBId, String levelCId, String packing, String unitName, Long unitId,
//                                     Double unitConv, Double qty, Double returnableQty, Double rate, Double baseAmt,
//                                     Double disAmt, Double disPer, Double disPerCal, Double disAmtCal, Double totalAmt,
//                                     Double gst, Double igst, Double cgst, Double sgst, Double totalIgst,
//                                     Double totalCgst, Double totalSgst, Double finalAmt, Double freeQty,
//                                     Double disPer2, Double rowDisAmt, Double grossAmt, Double addChgAmt,
//                                     Double grossAmt1, Double invoiceDisAmt, String transactionStatus, Long inventoryId,
//                                     Boolean isExpired, Long bDetailsId, String batchNo, String bExpiry,
//                                     Double purchaseRate, Boolean isBatch, Double minRateA, Double minRateB,
//                                     Double minRateC, String minDiscount, String maxDiscount, String manufacturingDate,
//                                     String marginPer, Double bRate, Double salesRate, Double costing,
//                                     Double costingWithTax) {
