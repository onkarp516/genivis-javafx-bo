...
public class SalesChallanInvoice {
    @SerializedName("id")
    @Expose
    private Integer id;
    ...
    @SerializedName("sc_bill_no")
    @Expose
    private String scBillNo;
    ...
    public String getScBillNo() {
        return scBillNo;
    }

    public void setScBillNo(String scBillNo) {
        this.scBillNo = scBillNo;
    }
