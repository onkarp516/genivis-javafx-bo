...
public class TranxSalesInvoiceResEditDTO implements Serializable {
        @SerializedName("id")
        @Expose
        private Long id;
        ...
        public TranxSalesInvoiceResEditDTO() {
        }
        ...
        public Long getSalesAcctId() {
                return salesAcctId;
        }

        public void setSalesAcctId(Long salesAcctId) {
                this.salesAcctId = salesAcctId;
        }

        public Long getSalesSrNo() {
                return salesSrNo;
        }

        public void setSalesSrNo(Long salesSrNo) {
