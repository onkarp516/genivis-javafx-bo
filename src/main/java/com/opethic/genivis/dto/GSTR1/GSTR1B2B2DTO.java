...
public class GSTR1B2B2DTO {
    ...
    private SimpleStringProperty referenceType;
    private SimpleStringProperty totalcgst;
    private SimpleStringProperty totalsgst;
    private SimpleStringProperty totaligst;
    private SimpleStringProperty tranxCode;


    public GSTR1B2B2DTO(String sr_no, String id, String invoice_no,String invoice_date,String sale_serial_number,String total_amount, String sundry_debtor_name,String sundry_debtor_id,
                        String sale_account_name,String narration,String tax_amt, String taxable_amt, String payment_mode, String referenceNo,
                        String referenceType, String totalcgst,String totalsgst, String totaligst, String tranxCode) {
        ...
        this.payment_mode = new SimpleStringProperty(payment_mode);
        this.referenceNo = new SimpleStringProperty(referenceNo);
        this.referenceType = new SimpleStringProperty(referenceType);
        ...
        this.tranxCode = new SimpleStringProperty(tranxCode);
    }
    ...
    public String getPayment_mode() {return payment_mode.get();}
    public SimpleStringProperty payment_modeProperty() {
        return payment_mode;
    }
    public void setPayment_mode(String payment_mode) { this.payment_mode=new SimpleStringProperty(payment_mode);}

    public String getReferenceNo() {return referenceNo.get();}
    public SimpleStringProperty referenceNoProperty() {
        return referenceNo;
    }
    public void setReferenceNo(String referenceNo) { this.referenceNo=new SimpleStringProperty(referenceNo);}
    ...
    public void setReferenceType(String referenceType) { this.referenceType=new SimpleStringProperty(referenceType);}
    ...
    public String getTranxCode() {return tranxCode.get();}
    public SimpleStringProperty tranxCodeProperty() {
        return tranxCode;
    }
    public void setTranxCode(String tranxCode) { this.tranxCode=new SimpleStringProperty(tranxCode);}
