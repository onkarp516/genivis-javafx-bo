...
public class GSTR1B2CSmall2DTO {
    ...
    public GSTR1B2CSmall2DTO(String sr_no, String id, String invoice_no, String invoice_date, String sale_serial_number, String total_amount,
