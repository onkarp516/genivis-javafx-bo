...
public class GSTR1DashboaedDTO {
    ...
    public String getVoucher_count() {
        return voucher_count.get();
    }

    public SimpleStringProperty voucher_countProperty() {
        return voucher_count;
    }

    public void setVoucher_count(String voucher_count) {
        this.voucher_count.set(voucher_count);
    }
